...
class RoadmapsControllerTest < ActionController::TestCase
  ...
  test "should create roadmap" do
    assert_difference('Roadmap.count') do
      post :create, roadmap: { country: @roadmap.country, rating: @roadmap.rating, user_id: @roadmap.user_id }
    end
  ...
  test "should update roadmap" do
    patch :update, id: @roadmap, roadmap: { country: @roadmap.country, rating: @roadmap.rating, user_id: @roadmap.user_id }
    assert_redirected_to roadmap_path(assigns(:roadmap))
  end
