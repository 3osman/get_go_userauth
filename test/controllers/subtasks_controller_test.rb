...
class SubtasksControllerTest < ActionController::TestCase
  ...
  test "should create subtask" do
    assert_difference('Subtask.count') do
      post :create, subtask: { deadline: @subtask.deadline, description: @subtask.description, done: @subtask.done, name: @subtask.name, task_id: @subtask.task_id }
    end
  ...
  test "should update subtask" do
    patch :update, id: @subtask, subtask: { deadline: @subtask.deadline, description: @subtask.description, done: @subtask.done, name: @subtask.name, task_id: @subtask.task_id }
    assert_redirected_to subtask_path(assigns(:subtask))
  end
